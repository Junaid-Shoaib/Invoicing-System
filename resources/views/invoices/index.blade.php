    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="mb-3">
                    <a href="#" class="btn btn-danger" id="pdf-export"><i class="fas fa-file-pdf"></i> Export PDF</a>
                    <a href="#" class="btn btn-success" id="excel-export"><i class="fas fa-file-excel"></i> Export Excel</a>
                </div>
